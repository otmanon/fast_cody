#version 150
 ...
 uniform mat4x3 primary_bones[20];
 uniform mat4x3 secondary_bones[20];
 ...
 void main()
 {
     ...
     for (int i = 0; i < 4; i++)
     {
         ...
         P += primary_weights_4[i] * primary_bones[i+12];
    	   P += primary_weights_5[i] * primary_bones[i+16];
	   ...
	   P += secondary_weights_5[i] * secondary_bones[i+16];
